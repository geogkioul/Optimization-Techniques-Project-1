function task_fibonacci(functions, a, b)
    % Inputs: 
    ...
    for i = 1:3 % For each function
        for j = 1:l_length % For every value of l
            ...
            [~, ~, f_vals] = fibonacci(functions{i}, a, b, l, e);
    ...
    for i=1:3 % For each function
        ...
        title(sprintf('Number of function %d evaluations for different l values - Fibonacci Method', i));
        legend('show');
        grid on;
    end
    ...
    for i = 1:3 % For each function
        ...
        for j = 1:l_length % For every value of l
            l = l_vals(j);
            % Run fibonacci with that value
            [a_vals, b_vals, ~] = fibonacci(functions{i}, a, b, l, e);
        ...
        title(sprintf('Values of interval borders [a,b] for function %d across iterations - Fibonacci Method', i));
